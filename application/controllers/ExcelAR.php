...
Class ExcelAR extends CI_Controller{
    ...
    function cetakAR(){
        ...
        $object->getActiveSheet()->getStyle("A1:BJ1")->applyFromArray(
                array(
                    'fill' => array(
        ...
        foreach($AllData as $row)
        {
           $object->getActiveSheet()->setCellValueByColumnAndRow(0, $excel_row, $row->no_transaksi);
            ...
            $object->getActiveSheet()->setCellValueByColumnAndRow(27, $excel_row, $row->no_inv_ship);
            $object->getActiveSheet()->setCellValueByColumnAndRow(28, $excel_row, $row->tgl_dok_ship);
            $object->getActiveSheet()->setCellValueByColumnAndRow(29, $excel_row, $row->tgl_inv_ship);
            $object->getActiveSheet()->setCellValueByColumnAndRow(30, $excel_row, $row->inv_ship_am);
            $object->getActiveSheet()->setCellValueByColumnAndRow(31, $excel_row, $row->no_faktur_ship);
            $object->getActiveSheet()->setCellValueByColumnAndRow(32, $excel_row, $row->tgl_inv_ship_pay);
            $object->getActiveSheet()->setCellValueByColumnAndRow(33, $excel_row, $row->inv_ship_paid_am);
            $object->getActiveSheet()->setCellValueByColumnAndRow(34, $excel_row, $row->no_inv_ship2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(35, $excel_row, $row->tgl_dok_ship2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(36, $excel_row, $row->tgl_inv_ship2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(37, $excel_row, $row->inv_ship_am2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(38, $excel_row, $row->no_faktur_ship2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(39, $excel_row, $row->tgl_inv_ship_pay2);
            ...
            $object->getActiveSheet()->setCellValueByColumnAndRow(47, $excel_row, $row->inv_uli_paid_am); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(48, $excel_row, $row->no_inv_uli2); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(49, $excel_row, $row->tgl_dok_uli2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(50, $excel_row, $row->tgl_inv_uli2); 
            $object->getActiveSheet()->setCellValueByColumnAndRow(51, $excel_row, $row->inv_uli_am2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(52, $excel_row, $row->no_faktur_uli2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(53, $excel_row, $row->tgl_inv_uli_pay2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(54, $excel_row, $row->inv_uli_paid_am2);
            $object->getActiveSheet()->setCellValueByColumnAndRow(55, $excel_row, $row->no_plug);
            $object->getActiveSheet()->setCellValueByColumnAndRow(56, $excel_row, $row->inv_plugar_date);
            $object->getActiveSheet()->setCellValueByColumnAndRow(57, $excel_row, $row->tgl_dok_plug);
            $object->getActiveSheet()->setCellValueByColumnAndRow(58, $excel_row, $row->inv_plugar_am );
            $object->getActiveSheet()->setCellValueByColumnAndRow(59, $excel_row, $row->plug_pay_date);
            $object->getActiveSheet()->setCellValueByColumnAndRow(60, $excel_row, $row->pay_plug_paid);
            $object->getActiveSheet()->setCellValueByColumnAndRow(61, $excel_row, $row->no_faktur);
            //AR
            $excel_row++;
        }
