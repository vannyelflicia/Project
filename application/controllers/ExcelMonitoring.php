<?php
Class ExcelMonitoring extends CI_Controller{
    ...
    function cetakMonitoring(){
        ...
        $object->getActiveSheet()->getStyle("A1:AJ1")->applyFromArray(
                array(
                    'fill' => array(
        ...
        $AllData = $this->pagemodel->getMonitoring();
        ...
        foreach($AllData as $row)
        {
           $object->getActiveSheet()->setCellValueByColumnAndRow(0, $excel_row, $row->no_transaksi);
            ...
            //OP
            $object->getActiveSheet()->setCellValueByColumnAndRow(27, $excel_row, $row->full_emptymc);
            $object->getActiveSheet()->setCellValueByColumnAndRow(28, $excel_row, $row->cust_balik);
            $object->getActiveSheet()->setCellValueByColumnAndRow(29, $excel_row, $row->no_sealmc);
            $object->getActiveSheet()->setCellValueByColumnAndRow(30, $excel_row, $row->tuj_balik);
            $object->getActiveSheet()->setCellValueByColumnAndRow(31, $excel_row, $row->kapal_balik);
            $object->getActiveSheet()->setCellValueByColumnAndRow(32, $excel_row, $row->stuff_date_balik);
            $object->getActiveSheet()->setCellValueByColumnAndRow(33, $excel_row, $row->ETD_balik);
            $object->getActiveSheet()->setCellValueByColumnAndRow(34, $excel_row, $row->ETA_balik);
            $object->getActiveSheet()->setCellValueByColumnAndRow(35, $excel_row, $row->tgl_dooring);
