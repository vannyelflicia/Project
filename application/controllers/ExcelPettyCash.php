    ...
    function cetakPettyCash(){
        ...
        foreach($AllData as $row)
        {
           $object->getActiveSheet()->setCellValueByColumnAndRow(0, $excel_row, $row->no_transaksi);
            ...
            //OP
            $object->getActiveSheet()->setCellValueByColumnAndRow(27, $excel_row, $row->b_stuff);
            $object->getActiveSheet()->setCellValueByColumnAndRow(28, $excel_row, $row->plus_b_stuff);
            $object->getActiveSheet()->setCellValueByColumnAndRow(29, $excel_row, $row->electricson);
            $object->getActiveSheet()->setCellValueByColumnAndRow(30, $excel_row, $row->b_karantina);
            $object->getActiveSheet()->setCellValueByColumnAndRow(31, $excel_row, $row->b_handlfull);
            $object->getActiveSheet()->setCellValueByColumnAndRow(32, $excel_row, $row->b_lolo);
            $object->getActiveSheet()->setCellValueByColumnAndRow(33, $excel_row, $row->b_adm);
            $object->getActiveSheet()->setCellValueByColumnAndRow(34, $excel_row, $row->b_lain);
            //PETTY CASH
            $excel_row++;
        }
