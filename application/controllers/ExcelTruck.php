<?php
Class ExcelTruck extends CI_Controller{
    ...
    function cetakTruck(){
        ...
        $object->getActiveSheet()->getStyle("A1:AN1")->applyFromArray(
                array(
                    'fill' => array(
        ...
        $AllData = $this->pagemodel->getTruck();
        ...
        foreach($AllData as $row)
        {
           $object->getActiveSheet()->setCellValueByColumnAndRow(0, $excel_row, $row->no_transaksi);
            ...
            //OP
            $object->getActiveSheet()->setCellValueByColumnAndRow(27, $excel_row, $row->inv_truck);
            $object->getActiveSheet()->setCellValueByColumnAndRow(28, $excel_row, $row->name);
            $object->getActiveSheet()->setCellValueByColumnAndRow(29, $excel_row, $row->date);
            $object->getActiveSheet()->setCellValueByColumnAndRow(30, $excel_row, $row->tujuan);
            $object->getActiveSheet()->setCellValueByColumnAndRow(31, $excel_row, $row->pesanan);
            $object->getActiveSheet()->setCellValueByColumnAndRow(32, $excel_row, $row->no_pol);
            $object->getActiveSheet()->setCellValueByColumnAndRow(33, $excel_row, $row->jam);
            $object->getActiveSheet()->setCellValueByColumnAndRow(34, $excel_row, $row->muatan);
            $object->getActiveSheet()->setCellValueByColumnAndRow(35, $excel_row, $row->ukuran);
            $object->getActiveSheet()->setCellValueByColumnAndRow(36, $excel_row, $row->b_jajan);
            $object->getActiveSheet()->setCellValueByColumnAndRow(37, $excel_row, $row->b_kom);
            $object->getActiveSheet()->setCellValueByColumnAndRow(38, $excel_row, $row->b_kawal);
            $object->getActiveSheet()->setCellValueByColumnAndRow(39, $excel_row, $row->b_lain);
            //TRUCK
            $excel_row++;
        }
