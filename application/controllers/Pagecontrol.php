...
class Pagecontrol extends CI_Controller {
	...
	function insertOP(){
		...
		} else
		{
			...
			redirect('Pagecontrol/formAP', 'refresh');
		}
	}
	...
	function dashMonitoring(){
		...
		$this->load->model('pagemodel');
		$data['datamonitoring'] = $this->pagemodel->getMonitoring();
	...
	function simpanDokumen_OP(){
		$this->load->model('pagemodel');
            ...
            $tgl_kirim_no = $this->input->post('tgl_kirim_no');
            $tgl_dok = $this->input->post('tgl_dok');
            $tgl_dok_ship_ar = $this->input->post('tgl_dok_ship_ar');
            $tgl_kirim_no2 = $this->input->post('tgl_kirim_no2');
            $tgl_dok2 = $this->input->post('tgl_dok2');
            $tgl_dok_ship_ar2 = $this->input->post('tgl_dok_ship_ar2');
            $tgl_dok_uli = $this->input->post('tgl_dok_uli');
            $tgl_dok_uli2 = $this->input->post('tgl_dok_uli2');
            $tgl_dok_uli2 = $this->input->post('tgl_dok_uli2');
            $tgl_dok_plugging = $this->input->post('tgl_dok_plugging');
            $tgl_kirim_dok_plugging = $this->input->post('tgl_kirim_dok_plugging');

		$data = array (
            'no_transaksidok' => $no_transaksidok,
            'IMOdok' => $IMOdok,
            'tgl_kirim_no' => $tgl_kirim_no,
            'tgl_dok' => $tgl_dok,
            'tgl_dok_ship_ar' => $tgl_dok_ship_ar,
            'tgl_kirim_no2' => $tgl_kirim_no2,
            'tgl_dok2' => $tgl_dok2,
            'tgl_dok_ship_ar2' => $tgl_dok_ship_ar2,
            'tgl_dok_uli' => $tgl_dok_uli,
            'tgl_dok_uli2' => $tgl_dok_uli2,
            'tgl_dok_plugging' => $tgl_dok_plugging,
            'tgl_kirim_dok_plugging' => $tgl_kirim_dok_plugging
            );
	...
	function cetak(){
        ...
        $object->getActiveSheet()->getStyle("H1")->applyFromArray(
			...
			$object->getActiveSheet()->getStyle("I1:T1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
                        'color' => array('rgb' => '#4169E1')
            ...
            $object->getActiveSheet()->getStyle("Z1:AA1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
                        'color' => array('rgb' => '#4169E1')
            ...
            $object->getActiveSheet()->getStyle("AB1:CK1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
            ...
            $object->getActiveSheet()->getStyle("CL1:DT1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
            ...
            $object->getActiveSheet()->getStyle("DU1:EG1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
            ...
            $object->getActiveSheet()->getStyle("EH1:EO1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
            ...
            $object->getActiveSheet()->getStyle("EP1:EX1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
            ...
            $object->getActiveSheet()->getStyle("EY1:FD1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
                        'color' => array('rgb' => '#CD5C5C')
            ...
            $object->getActiveSheet()->getStyle("FE1")->applyFromArray(
                array(
                    'fill' => array(
                        'type' => PHPExcel_Style_Fill::FILL_SOLID,
                        'color' => array('rgb' => '#3CB371')
		...
		$table_columns = array("No Transaksi" , "IMO" , "No. & Size Container" , "Name CUST" , "No. Shipment 1" ,"Tanggal Terima Dokumen Shipment 1" , "No. Shipment 2" , "Tanggal Terima Dokumen Shipment 2" , "No. Seal" , "Full / Empty" , "Reefer / Dry" , "Stuffing Date" , "Container In / Out" , "Origin Town" , "Destination Town" , "Vessel Name" , "Delivery From JKT (ETD)" , "Arv At Dest (ETA)" , "Tanggal Dooring Container" , "No. Shipment ULI HUB 1" , "Tanggal Terima Dokumen Shipment ULI HUB 1" , "Tujuan Shipment ULI HUB 1" , "Tgl Dooring Shipment ULI HUB 1" , "No. Shipment ULI HUB 2" , "Tanggal Terima Dokumen Shipment ULI HUB 2" , "Tujuan Shipment ULI HUB 2" , "Tgl Dooring Shipment ULI HUB 2" , 
			//23 & 4
			"Name AGEN" ,"Invoice No. AGEN" ,"Invoice AGEN date" ,"Tgl Terima Invoice" ,"Invoice AGEN Amount" ,"Payment amount AGEN" ,"Payment Date AGEN" , "Invoice No. GENSET" , "Invoice GENSET date" , "Tgl Terima Invoice" , "Invoice GENSET Amount" , "Payment GENSET" , "Payment Date GENSET" , "Invoice No. BJTI" , "Invoice BJTI date" , "Tgl Terima Invoice" , "Invoice BJTI Amount" , "Payment BJTI" , "Payment Date BJTI" , "Name SHIP" , "Invoice No. SHIP" , "Invoice SHIP date" , "Tgl Terima Invoice" , "Invoice SHIP Amount" , "Payment SHIP" , "Payment Date SHIP" , "Invoice No. THC" , "Invoice THC date" , "Tgl Terima Invoice" , "Invoice THC Amount" , "Payment THC" , "Payment Date THC" , "Invoice No. PLUG" , "Invoice PLUG date" , "Tgl Terima Invoice" , "Invoice PLUG Amount" , "Payment PLUG" , "Payment Date PLUG" , "Invoice No. Buruh" , "Invoice Buruh date" , "Tgl Terima Invoice" , "Invoice Buruh Amount" , "Payment Buruh" , "Payment Date Buruh" , "No. Invoice Shipment ULI HUB 1" , "Tgl Invoice Shipment ULI HUB 1" , "Tgl Terima Invoice" , "Invoice Shipment ULI HUB 1 Amount" , "Payment Shipment ULI HUB 1" , "Payment Date Shipment ULI HUB 1" , "No. Invoice Shipment ULI HUB 2" , "Tgl Invoice Shipment ULI HUB 2" , "Tgl Terima Invoice" , "Payment Date Shipment ULI HUB 2 Amount" , "Payment Shipment ULI HUB 2" , "Payment Date Shipment ULI HUB 2" , "Invoice No. LAIN" , "Invoice LAIN date" , "Tgl Terima Invoice" , "Invoice LAIN Amount" , "Payment LAIN" , "Payment Date LAIN" ,
			//62
			"No. Invoice Shipment 1", "Tanggal Terima Dokumen Shipment 1", "Invoice Shipment 1 Date", "Invoice Shipment 1 Amount", "No. Faktur Pajak Shipment 1", "Invoice Shipment 1 Payment Date", "Invoice Shipment 1 Paid Amount", "No. Invoice Shipment 2", "Tanggal Terima Dokumen Shipment 2", "Invoice Shipment 2 Date", "Invoice Shipment 2 Amount", "No. Faktur Pajak Shipment 2", "Invoice Shipment 2 Payment Date", "Invoice Shipment 2 Paid Amount", "No. Invoice ULI HUB Shipment 1", "Tanggal Terima Dokumen  ULI HUB Shipment 1", "Invoice ULI HUB Shipment 1 Date", "Invoice ULI HUB Shipment 1 Amount", "No. Faktur Pajak ULI HUB Shipment 1", "Invoice ULI HUB Shipment 1 Payment Date", "Invoice ULI HUB Shipment 1 Paid Amount", "No. Invoice ULI HUB Shipment 2", "Tanggal Terima Dokumen  ULI HUB Shipment 2", "Invoice ULI HUB Shipment 2 Date", "Invoice ULI HUB Shipment 2 Amount", "No. Faktur Pajak ULI HUB Shipment 2", "Invoice ULI HUB Shipment 2 Payment Date", "Invoice ULI HUB Shipment 2 Paid Amount", "No. Plug", "Invoice Plug Date", "Tanggal Terima Dokumen Plug", "Invoice Plug Amount", "Plug Payment Date", "Plug Paid Amount", "No. Faktur Pajak" ,
			//35
			...
			//8
		 	"Balikan Full/Empty" , "CUST Balikan" , "No. Seal" , "Kota Tujuan Balikan" , "Nama Kapal Balikan" , "Tanggal Stuff Balikan" , "ETD Kapal Balikan" , "ETA Kapal Balikan" , "Tanggal Dooring/Balik Depo" ,
		 	//9
		 	"Tanggal Kirim Dokumen No. Shipment 1 ke AR" , "Tanggal Kirim Dokumen Shipment 1 ke AR" , "Tanggal Kirim Dokumen No. Shipment 2 ke AR" , "Tanggal Kirim Dokumen Shipment 2 ke AR" , "Tanggal Terima Dokumen Plugging" , "Tanggal Kirim Dokumen Plugging Ke AR" ,
		 	//6
		 	"Tanggal Kirim Dokumen Plugging ke AR oleh AP"
			);
		$column = 0;
		...
		foreach($AllData as $row)
		{
			...
			$object->getActiveSheet()->setCellValueByColumnAndRow(6, $excel_row, $row->no_shipment2); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(7, $excel_row, $row->tgl_dok2); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(8, $excel_row, $row->no_seal); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(9, $excel_row, $row->full_empty); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row, $row->reefer_dry); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(11, $excel_row, $row->stuff_date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(12, $excel_row, $row->in_out); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(13, $excel_row, $row->origin_town);
			$object->getActiveSheet()->setCellValueByColumnAndRow(14, $excel_row, $row->dest_town);
			$object->getActiveSheet()->setCellValueByColumnAndRow(15, $excel_row, $row->vessel_name);
			$object->getActiveSheet()->setCellValueByColumnAndRow(16, $excel_row, $row->deliv_date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(17, $excel_row, $row->arv_at_dest);
			...
			$object->getActiveSheet()->setCellValueByColumnAndRow(21, $excel_row, $row->tuj_ship_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(22, $excel_row, $row->tgl_door_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(23, $excel_row, $row->no_ship_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(24, $excel_row, $row->tgl_dok_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(25, $excel_row, $row->tuj_ship_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(26, $excel_row, $row->tgl_door_uli2);
			//OP
			$object->getActiveSheet()->setCellValueByColumnAndRow(27, $excel_row, $row->name_ag);
			$object->getActiveSheet()->setCellValueByColumnAndRow(28, $excel_row, $row->inv_ag);
			$object->getActiveSheet()->setCellValueByColumnAndRow(29, $excel_row, $row->inv_ag_date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(30, $excel_row, $row->tgl_trima_inv_ag);
			$object->getActiveSheet()->setCellValueByColumnAndRow(31, $excel_row, $row->inv_ag_am);
			$object->getActiveSheet()->setCellValueByColumnAndRow(32, $excel_row, $row->pay_ag);
			$object->getActiveSheet()->setCellValueByColumnAndRow(33, $excel_row, $row->date_ag);
			...
			$object->getActiveSheet()->setCellValueByColumnAndRow(65, $excel_row, $row->inv_buruh);
			$object->getActiveSheet()->setCellValueByColumnAndRow(66, $excel_row, $row->inv_buruh_date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(67, $excel_row, $row->tgl_trima_inv_buruh);
			$object->getActiveSheet()->setCellValueByColumnAndRow(68, $excel_row, $row->inv_buruh_am);
			$object->getActiveSheet()->setCellValueByColumnAndRow(69, $excel_row, $row->pay_buruh);
			$object->getActiveSheet()->setCellValueByColumnAndRow(70, $excel_row, $row->date_buruh);
			$object->getActiveSheet()->setCellValueByColumnAndRow(71, $excel_row, $row->inv_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(72, $excel_row, $row->tgl_inv_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(73, $excel_row, $row->tgl_trima_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(74, $excel_row, $row->inv_uli_am);
			$object->getActiveSheet()->setCellValueByColumnAndRow(75, $excel_row, $row->pay_ship_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(76, $excel_row, $row->pay_date_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(77, $excel_row, $row->inv_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(78, $excel_row, $row->tgl_inv_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(79, $excel_row, $row->tgl_trima_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(80, $excel_row, $row->inv_uli_am2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(81, $excel_row, $row->pay_ship_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(82, $excel_row, $row->pay_date_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(83, $excel_row, $row->inv_lain);
			$object->getActiveSheet()->setCellValueByColumnAndRow(84, $excel_row, $row->inv_lain_date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(85, $excel_row, $row->tgl_trima_inv_lain);
			$object->getActiveSheet()->setCellValueByColumnAndRow(86, $excel_row, $row->inv_lain_am);
			$object->getActiveSheet()->setCellValueByColumnAndRow(87, $excel_row, $row->pay_lain);
			$object->getActiveSheet()->setCellValueByColumnAndRow(88, $excel_row, $row->date_lain);
			//AP
			$object->getActiveSheet()->setCellValueByColumnAndRow(89, $excel_row, $row->no_inv_ship);
			$object->getActiveSheet()->setCellValueByColumnAndRow(90, $excel_row, $row->tgl_dok_ship);
			$object->getActiveSheet()->setCellValueByColumnAndRow(91, $excel_row, $row->tgl_inv_ship);
			$object->getActiveSheet()->setCellValueByColumnAndRow(92, $excel_row, $row->inv_ship_am);
			$object->getActiveSheet()->setCellValueByColumnAndRow(93, $excel_row, $row->no_faktur_ship);
			$object->getActiveSheet()->setCellValueByColumnAndRow(94, $excel_row, $row->tgl_inv_ship_pay);
			$object->getActiveSheet()->setCellValueByColumnAndRow(95, $excel_row, $row->inv_ship_paid_am);
			$object->getActiveSheet()->setCellValueByColumnAndRow(96, $excel_row, $row->no_inv_ship2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(97, $excel_row, $row->tgl_dok_ship2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(98, $excel_row, $row->tgl_inv_ship2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(99, $excel_row, $row->inv_ship_am2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(100, $excel_row, $row->no_faktur_ship2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(101, $excel_row, $row->tgl_inv_ship_pay2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(102, $excel_row, $row->inv_ship_paid_am2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(103, $excel_row, $row->no_inv_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(104, $excel_row, $row->tgl_dok_uli);
			$object->getActiveSheet()->setCellValueByColumnAndRow(105, $excel_row, $row->tgl_inv_uli); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(106, $excel_row, $row->inv_uli_am);
			$object->getActiveSheet()->setCellValueByColumnAndRow(107, $excel_row, $row->no_faktur_uli); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(108, $excel_row, $row->tgl_inv_uli_pay);
			$object->getActiveSheet()->setCellValueByColumnAndRow(109, $excel_row, $row->inv_uli_paid_am); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(110, $excel_row, $row->no_inv_uli2); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(111, $excel_row, $row->tgl_dok_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(112, $excel_row, $row->tgl_inv_uli2); 
			$object->getActiveSheet()->setCellValueByColumnAndRow(113, $excel_row, $row->inv_uli_am2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(114, $excel_row, $row->no_faktur_uli2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(115, $excel_row, $row->tgl_inv_uli_pay2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(116, $excel_row, $row->inv_uli_paid_am2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(117, $excel_row, $row->no_plug);
			$object->getActiveSheet()->setCellValueByColumnAndRow(118, $excel_row, $row->inv_plugar_date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(119, $excel_row, $row->tgl_dok_plug);
			$object->getActiveSheet()->setCellValueByColumnAndRow(120, $excel_row, $row->inv_plugar_am );
			$object->getActiveSheet()->setCellValueByColumnAndRow(121, $excel_row, $row->plug_pay_date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(122, $excel_row, $row->pay_plug_paid);
			$object->getActiveSheet()->setCellValueByColumnAndRow(123, $excel_row, $row->no_faktur);
			//AR
			$object->getActiveSheet()->setCellValueByColumnAndRow(124, $excel_row, $row->inv_truck);
			$object->getActiveSheet()->setCellValueByColumnAndRow(125, $excel_row, $row->name);
			$object->getActiveSheet()->setCellValueByColumnAndRow(126, $excel_row, $row->date);
			$object->getActiveSheet()->setCellValueByColumnAndRow(127, $excel_row, $row->tujuan);
			$object->getActiveSheet()->setCellValueByColumnAndRow(128, $excel_row, $row->pesanan);
			$object->getActiveSheet()->setCellValueByColumnAndRow(129, $excel_row, $row->no_pol);
			$object->getActiveSheet()->setCellValueByColumnAndRow(130, $excel_row, $row->jam);
			$object->getActiveSheet()->setCellValueByColumnAndRow(131, $excel_row, $row->muatan);
			$object->getActiveSheet()->setCellValueByColumnAndRow(132, $excel_row, $row->ukuran);
			$object->getActiveSheet()->setCellValueByColumnAndRow(133, $excel_row, $row->b_jajan);
			$object->getActiveSheet()->setCellValueByColumnAndRow(134, $excel_row, $row->b_kom);
			$object->getActiveSheet()->setCellValueByColumnAndRow(135, $excel_row, $row->b_kawal);
			$object->getActiveSheet()->setCellValueByColumnAndRow(136, $excel_row, $row->b_lain);
			//TRUCK
			$object->getActiveSheet()->setCellValueByColumnAndRow(137, $excel_row, $row->b_stuff);
			$object->getActiveSheet()->setCellValueByColumnAndRow(138, $excel_row, $row->plus_b_stuff);
			$object->getActiveSheet()->setCellValueByColumnAndRow(139, $excel_row, $row->electricson);
			$object->getActiveSheet()->setCellValueByColumnAndRow(140, $excel_row, $row->b_karantina);
			$object->getActiveSheet()->setCellValueByColumnAndRow(141, $excel_row, $row->b_handlfull);
			$object->getActiveSheet()->setCellValueByColumnAndRow(142, $excel_row, $row->b_lolo);
			$object->getActiveSheet()->setCellValueByColumnAndRow(143, $excel_row, $row->b_adm);
			$object->getActiveSheet()->setCellValueByColumnAndRow(144, $excel_row, $row->b_lain);
			//PETTY CASH
			$object->getActiveSheet()->setCellValueByColumnAndRow(145, $excel_row, $row->full_emptymc);
			$object->getActiveSheet()->setCellValueByColumnAndRow(146, $excel_row, $row->cust_balik);
			$object->getActiveSheet()->setCellValueByColumnAndRow(147, $excel_row, $row->no_sealmc);
			$object->getActiveSheet()->setCellValueByColumnAndRow(148, $excel_row, $row->tuj_balik);
			$object->getActiveSheet()->setCellValueByColumnAndRow(149, $excel_row, $row->kapal_balik);
			$object->getActiveSheet()->setCellValueByColumnAndRow(150, $excel_row, $row->stuff_date_balik);
			$object->getActiveSheet()->setCellValueByColumnAndRow(151, $excel_row, $row->ETD_balik);
			$object->getActiveSheet()->setCellValueByColumnAndRow(152, $excel_row, $row->ETA_balik);
			$object->getActiveSheet()->setCellValueByColumnAndRow(153, $excel_row, $row->tgl_dooring);
			//MONITORING CONTAINER
			$object->getActiveSheet()->setCellValueByColumnAndRow(154, $excel_row, $row->tgl_kirim_no);
			$object->getActiveSheet()->setCellValueByColumnAndRow(155, $excel_row, $row->tgl_dok_ship_ar);
			$object->getActiveSheet()->setCellValueByColumnAndRow(156, $excel_row, $row->tgl_kirim_no2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(157, $excel_row, $row->tgl_dok_ship_ar2);
			$object->getActiveSheet()->setCellValueByColumnAndRow(158, $excel_row, $row->tgl_dok_plugging);
			$object->getActiveSheet()->setCellValueByColumnAndRow(159, $excel_row, $row->tgl_kirim_dok_plugging);
			//tambahan dokumen OP
			$object->getActiveSheet()->setCellValueByColumnAndRow(160, $excel_row, $row->tgl_kirim_plug_ar);
			//tambahan AP
			$excel_row++;
		}
