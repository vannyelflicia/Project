 ...
 -->                     <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                     <?php foreach ($datamonitoring as $k) { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        <a href="editMonitoring/<?php echo $k->no_transaksi; ?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></button> </a> 
                                        <a href="delMonitoring/<?php echo $k->no_transaksi; ?>"><button type="button" class="btn btn-danger btn-circle"><i class="glyphicon glyphicon-trash"></i></button> </a> 
                                        </td>
                                    </tr>  
                                    <?php } ?>  
