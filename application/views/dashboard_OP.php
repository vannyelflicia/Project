            ...
            <div class="row">
             ...
             <div class="row">
                ...
                <div class="col-md-offset-11" style="padding-bottom: 10px">
                    <a href="<?php echo base_url()."index.php/pagecontrol/formOP"?>"><button type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i>  ADD</button></a>
                </div>
                    <div class="panel panel-primary">
                        <div class="panel-heading" >
                            <center>Data OP Table</center>
                        </div>
                        ...
                        <div class="table-responsive-sm">
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                        <a href="editOP/<?php echo $key->no_transaksi; ?>">
                                        <button type="button" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></button>
                                        </a>
                                        <a href="delOP/<?php echo $key->no_transaksi; ?>">
                    ...
                    <a href="<?php echo base_url()."index.php/excelOP/cetakOP"?>"><button type="button" class="btn btn-success"><i class="fa   fa-download"></i>  DOWNLOAD </button></a>
                        </div>
                    <!-- /.panel
                    </div> -->
                </div>
