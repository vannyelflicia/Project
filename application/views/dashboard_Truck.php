                            ...
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        <a href="editTruck/<?php echo $k->no_transaksi; ?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-edit"></i></button> </a>  
                                        <a href="delTruck/<?php echo $k->no_transaksi; ?>">
                                        <button type="button" class="btn btn-danger btn-circle"><i class="glyphicon glyphicon-trash"></i></button>
                                        <a href="exportTruck/<?php echo $k->no_transaksi; ?>"><button type="button" class="btn btn-success btn-circle"><i class="fa fa-download"></i></button> </a> 
                                        </a>
                                        </td>
                                    </tr>  
                                    <?php } ?>
