                            ...
                            <table id="dtHorizontalExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                <thead>
                                    <tr >
                                        ...
                                        <th>Name CUST</th>
                                        <th>No. Shipment 1</th>
                                        <th style="background-color: LightBlue">Tanggal Kirim Dokumen No. Shipment 1</th>
                                        ...
                                        <th>No. Shipment 2</th>
                                        <th style="background-color: LightBlue">Tanggal Kirim Dokumen No. Shipment 2</th>
                                        ...
                                        <th style="background-color: LightBlue">Tanggal Terima Dokumen Plugging</th>
                                        <th style="background-color: LightBlue">Tanggal Kirim Dokumen Plugging ke AR</th> 
                                        <!-- OP -->
                                        ...
                                        <th style="background-color: Silver">Tanggal Kirim Dokumen Plug ke AR</th>
                                        ...
                                        <th style="background-color: palegreen">Payment Date Shipment ULI HUB 1 Amount</th>
                                        ...
                                        <th style="background-color: palegreen">Payment Date Shipment ULI HUB 2 Amount</th> 
                                        ...
                                        <th style="background-color: LightCoral">Biaya Jajan</th>
                                        ...
                                        <!-- TRUCK -->
                                        <th style="background-color: DarkSalmon">Balikan Full/Empty</th>
                                        <th style="background-color: DarkSalmon">CUST Balikan</th>
                                        <th style="background-color: DarkSalmon">No. Seal</th>
                                        <th style="background-color: DarkSalmon">Kota Tujuan Balikan</th>
                                        <th style="background-color: DarkSalmon">Nama Kapal Balikan</th>
                                        <th style="background-color: DarkSalmon">Tanggal Stuff Balikan</th>
                                        <th style="background-color: DarkSalmon">ETD Kapal Balikan</th>
                                        <th style="background-color: DarkSalmon">ETA Kapal Balikan</th>
                                        <th style="background-color: DarkSalmon">Tanggal Dooring/Balik Depo</th>
                                        <!-- MONITORING -->
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td style="background-color: LightBlue"><?php echo $k->tgl_kirim_no ?></td>
                                        ...
                                        <td style="background-color: LightBlue"><?php echo $k->tgl_kirim_no2 ?></td>
                                        ...
                                        <td style="background-color: LightBlue"><?php echo $k->tgl_dok_plugging ?></td>
                                        <td style="background-color: LightBlue"><?php echo $k->tgl_kirim_dok_plugging ?></td>
                                        <!-- OP -->
                                        ...
                                        <td style="background-color: LightCoral"><?php echo $k->b_lain ?></td>
                                        <!-- TRUCK -->
                                        <td style="background-color: DarkSalmon"><?php echo $k->full_emptymc ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->cust_balik ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->no_sealmc ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->tuj_balik ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->kapal_balik ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->stuff_date_balik ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->ETD_balik ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->ETA_balik ?></td>
                                        <td style="background-color: DarkSalmon"><?php echo $k->tgl_dooring ?></td>
                                        <!-- MONITORING -->
