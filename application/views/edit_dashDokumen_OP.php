                            ...
                            <div class="col-md-offset-2">
                                <div class="col-lg-8">
                                    ...
                                    <?php foreach ($editDokumen_OP as $r) { ?>
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Kirim Dokumen No. Shipment 1 ke AR</label>
                                            <input type="date" class="form-control" value="<?php echo $r->tgl_kirim_no ?>" name="tgl_kirim_no">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Kirim Dokumen No. Shipment 2 ke AR</label>
                                            <input type="date" class="form-control" value="<?php echo $r->tgl_kirim_no2 ?>" name="tgl_kirim_no2">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Kirim Dokumen Shipment 2 ke AR</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="<?php echo $r->tgl_kirim_dok_plugging ?>" name="tgl_kirim_dok_plugging">
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal Terima Dokumen Plugging</label>
                                            <input type="date" class="form-control" value="<?php echo $r->tgl_dok_plugging ?>" name="tgl_dok_plugging">
                                        </div>
                                        <div class="form-group">
                                            <label>Tanggal Kirim Dokumen Plugging</label>
                                            <input type="date" class="form-control" value="<?php echo $r->tgl_dok2 ?>" name="tgl_dok2">
                                        </div>
                                    <?php } ?>
